...
$('#galeria').galereya({wave: false,  noCategoryName: 'Todos', modifier: 'noDesc'});

$(document).ready(function() {
    
    // The bottom_of_galereya will be at leats at the botton of the screen
    // Because bottom_of_galereya is initially defined as the height of the page
    var bottom_of_galereya = $(window).scrollTop() + $(window).height();;
        
    /* Every time the window is scrolled ... */
    $(window).scroll( function(){    
        
        // the footer will be draged to the botton until the end of galereya
        $('.galereya-cell').each(function(i){
            var bottom_of_cell = $(this).offset().top+$(this).outerHeight(true);
            if (bottom_of_cell > bottom_of_galereya) { bottom_of_galereya = bottom_of_cell }
        });
        $('footer').css({top: bottom_of_galereya + 'px', position: 'absolute', width: '100%'});
    });
